        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="/admin"
               >
                ...
                <span class="ms-1 font-weight-bold"> Quản trị</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link " href="{{route('admin.tags')}}">
                        ...
                        <span class="nav-link-text ms-1">Quản lý thẻ tags</span>
                    </a>
                </li> --}}
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="#">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <img width="20" height="20" class="rounded-circle" src="{{auth()->user()->avatar}}" alt="">
                        </div>
                        <span class="nav-link-text ms-1">Hi, {{auth()->user()->name}}</span>
                    </a>
                </li>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://mr-quynh.com" class="font-weight-bold" target="_blank">Creative
                                    Mr Quynh</a>
                                for all love.
                            </div>
                        </div>
                            ...
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://www.creative-tim.com" class="nav-link text-muted"
                                        target="_blank">Creative Mr Quynh</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://mr-quynh.com" class="nav-link text-muted"
                                ...
                                <li class="nav-item">
                                    <a href="https://mr-quynh.com" class="nav-link pe-0 text-muted"
